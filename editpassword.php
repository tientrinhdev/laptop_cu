...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $user = User::getByUsername($conn, $username, $password_cu);
    if (!empty($user)) {
...
<!-- form đổi mật khẩu -->
<div class="content">
    <form action="" method="post" id="frmEDITPASSWORD">
        <fieldset>
            ...
            <div class="row">
                ...
                <input name="username" disabled id="username" type="text" placeholder="Tên tài khoản" value="<? echo $username ?>">
