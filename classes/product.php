...
class Product
{
    ...
    public function __construct($productname = null, $branch = null, $description = null, $price = null, $imagefile = null)
    {
...
//Hàm thêm vào thông tin
    public function add($conn)
    {
        if ($this->validate()) {
            try {
                $sql = "insert into products (productname, branch, description, price, imagefile) values (:productname, :branch, :description, :price, :imagefile)";
